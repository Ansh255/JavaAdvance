...
<h1 class="font-weight-bold"> Smart Contact Manager<br><p class="fw-lighter fs-4">Smart Collecting your contacts in very smarter way.
We Provide very Effective and smarterway of handling contact</p><button class="btn bg-primary text-white">Get Started</button></h1><br>
</div>
